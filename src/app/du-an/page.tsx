    ...
    <div className="bg-white py-12 sm:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        {projectsList.length === 0 ? (
          <div className="bg-surface rounded-3xl border border-dashed border-gray-200/80 p-16 text-center max-w-2xl mx-auto space-y-4 shadow-sm">
            ...
            <p className="text-xs text-gray-500 font-semibold pt-2">
              Mọi dự án gây quỹ chính thức sẽ được công bố minh bạch tại đây và trên Fanpage của CLB.
            </p>
          </div>
        ) : (
