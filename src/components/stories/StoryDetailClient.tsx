  ...
  "bep-yeu-thuong-lan-1-benh-vien-que-son": [
    {
      ...
      content: "Sáng sớm nhận được bát cháo nóng hổi thơm ngon của các cháu trong chương trình Bếp Yêu Thương mà ấm lòng quá. Chăm người nhà nằm viện tốn kém, có bữa sáng nghĩa tình thế này quý giá lắm. Cảm ơn các cháu CLB rất nhiều!",
      createdAt: "10/09/2026",
    },
    {
      id: "cmt-seed-8-2",
      authorName: "Trương Hoàng Long",
      content: "Thấy nụ cười và lời cảm ơn chân thành của các cô chú bệnh nhân là bao mệt nhọc thức khuya dậy sớm chuẩn bị cho Bếp Yêu Thương lần 1 đều tan biến hết. Vợ chồng mình rất vui khi được chung tay gieo duyên cùng Hoa Trên Đá!",
      createdAt: "10/09/2026",
    },
    {
      id: "cmt-seed-8-3",
      authorName: "Thu Hằng (TNV)",
      content: "Nồi cháo đầy ắp thịt bằm, bí đỏ và hạt sen thơm phức. Nhìn các cô chú ăn ngon miệng mà thương vô cùng. Hẹn gặp lại mọi người ở những chuyến Bếp Yêu Thương tiếp theo nhé!",
