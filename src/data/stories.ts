...
export const stories: Story[] = [
  {
    id: 'story-9',
    title: 'Bếp Yêu Thương lần 2: Nồi cháo nghĩa tình tại Bệnh viện Duy Xuyên',
    slug: 'bep-yeu-thuong-lan-2-benh-vien-duy-xuyen',
    excerpt: 'Tiếp nối thành công của Bếp Yêu Thương lần 1, CLB Hoa Trên Đá đã mang những phần cháo ấm nóng, bổ dưỡng đến với các bệnh nhân và thân nhân nghèo tại Trung tâm Y tế huyện Duy Xuyên.',
    content: `Sau chuyến hành trình Bếp Yêu Thương lần 1 đong đầy cảm xúc tại Quế Sơn, ngọn lửa của sự sẻ chia tiếp tục được các thành viên Câu lạc bộ Thiện nguyện Hoa Trên Đá thắp sáng và trao gửi đến điểm dừng chân tiếp theo: Trung tâm Y tế huyện Duy Xuyên.

Sáng sớm ngày 21/09/2026, giữa tiết trời se lạnh đầu thu, gian bếp nhỏ của câu lạc bộ đã đỏ lửa từ rất sớm. Mùi gạo thơm hòa cùng vị ngọt của thịt bằm, rau củ và hạt sen tươi lan tỏa, đánh thức một buổi sớm tinh mơ đầy hân hoan của đội ngũ tình nguyện viên. Từng công đoạn sơ chế, nấu cháo, đóng hộp và vận chuyển đều được mọi người thực hiện cẩn trọng, tỉ mỉ với tất cả sự chu đáo và lòng trắc ẩn.

Khi xe cháo dừng trước sân Bệnh viện Duy Xuyên, những làn khói nghi ngút bốc lên mang theo hơi ấm giữa hành lang bệnh viện. Từng bát cháo nóng sốt được các bạn trẻ Hoa Trên Đá trân trọng trao tận tay từng người bệnh, từng thân nhân đang ngày đêm túc trực chăm sóc người nhà.

https://youtu.be/Dw0vX-zKkRA
...
Hoa Trên Đá — Từ đá nở hoa, từ tâm lan tỏa.`,
  ...
  },
  {
    ...
    content: `Có những cái tên được nghĩ ra trong một buổi họp chớp nhoáng. Nhưng cũng có những cái tên phải đi qua rất nhiều hành trình, gom nhặt từ nhiều trải nghiệm mới tìm được nơi để thuộc về. “Hoa Trên Đá” là một cái tên như thế.

Nhiều năm trước, anh Đoàn Xuân Lộc có duyên kết nối và đồng hành cùng một câu lạc bộ thiện nguyện. Ở đó có một tinh thần rất đặc biệt: muốn kêu gọi sự sẻ chia từ cộng đồng, trước hết chính mình cũng phải dốc lòng hành động.

Thay vì chỉ đứng lên kêu gọi, mọi người khi ấy đã chọn những hành trình đầy thử thách bằng chính sức mình: có những chuyến rong ruổi bằng xe đạp, có những hành trình đi bộ đường dài qua bao cung đường dốc núi. Những chuyến đi ấy chỉ với một mong muốn giản dị: làm điều gì đó thực chất bằng mồ hôi và tâm sức của mình để gây quỹ cho những chuyến thiện nguyện tiếp theo.

Và rồi trong một hành trình như thế, một ý tưởng mộc mạc xuất hiện: mang những viên đá cuội về, cùng nhau tỉ mẩn vẽ lên chúng những bức tranh cỏ cây, sông núi, rồi bán đấu giá để gây quỹ giúp đỡ các em nhỏ vùng cao.

Những viên đá cuội vốn khô cứng, vô tri ven suối, qua đôi bàn tay và tấm lòng của mọi người lại trở thành những kỷ vật mang theo câu chuyện, màu sắc và hy vọng. Có lẽ từ giây phút ấy, cái tên “Hoa Trên Đá” đã bắt đầu hình thành một ý nghĩa thiêng liêng.

Hoa là biểu tượng của sự sống, của hy vọng và những điều tươi đẹp. Còn đá là những khô cằn, thử thách và những hoàn cảnh khắc nghiệt của cuộc đời. Một bông hoa có thể kiên cường nở trên đá cũng giống như một điều tử tế, chân thành vẫn luôn có thể được sinh ra giữa những nghịch cảnh gian nan nhất.

![Hoạt động vẽ đá gây quỹ thiện nguyện](/images/bai1_anh1.webp)

Đến năm 2026, anh Đoàn Xuân Lộc cùng những người đồng đội tâm huyết quyết định đi xa hơn một hoạt động ngắn ngày. Mọi người muốn xây dựng một câu lạc bộ thiện nguyện chính quy, bền chặt, nơi những người cùng chung lý tưởng có thể gặp gỡ, gắn bó và cùng nhau đi đường dài.

Và cái tên Câu lạc bộ Thiện nguyện Hoa Trên Đá chính thức ra đời, mang theo phương châm hành động giản dị mà sâu lắng: “Từ đá nở hoa, từ tâm lan tỏa”.

Bởi chúng mình tin rằng, từ những nơi gian khó nhất vẫn có thể đâm chồi những điều đẹp đẽ. Và từ một tấm lòng chân thành, ngọn lửa yêu thương sẽ tự khắc được thắp sáng và lan tỏa từ người này sang người khác.`,
    coverImage: '/images/bai1_anh1.webp',
    authorName: 'Đoàn Xuân Lộc',
    storyType: 'Góc nhìn thành viên',
    featured: true,
    status: 'published',
  ...
  },
  {
    ...
    content: `Câu lạc bộ Thiện nguyện Hoa Trên Đá chính thức mang tên mình từ năm 2026. Nhưng hành trình của những con người trong tập thể này thực ra đã bắt đầu từ rất nhiều năm trước đó.

Trước khi thành lập Hoa Trên Đá, nhiều thành viên nòng cốt đã có thời gian dài gắn bó và hoạt động cùng nhau trong Câu lạc bộ Ngân hàng Máu sống Quế Xuân 2, đơn vị trực thuộc Mạng lưới Tình nguyện Quốc gia khu vực Miền Trung.

Từ những đợt hiến máu khẩn cấp cứu người trong đêm, các hoạt động hỗ trợ y tế cộng đồng, đến những chuyến xe chở nhu yếu phẩm về với các hoàn cảnh ngặt nghèo tại các vùng nông thôn khó khăn, từng chuyến đi thực tế đã dạy cho chúng mình rất nhiều bài học quý giá.

Thiện nguyện không đơn thuần là trao đi một phần quà hay một số tiền. Đó là trách nhiệm với những gì mình đã nhận từ cộng đồng, là sự tìm hiểu kỹ càng trước khi giúp đỡ để nguồn lực đến đúng nơi, làm đúng việc mà bà con thực sự cần. Và quan trọng hơn cả, đó là sự bền bỉ để không chỉ xuất hiện một lần rồi biến mất.

![Các thành viên tham gia hoạt động cộng đồng](/images/bai2_2.webp)

Qua năm tháng, tập thể nhận thấy cần phải bước sang một giai đoạn mới: xây dựng một tổ chức thiện nguyện có định hướng dài hạn, có quy chế trách nhiệm rõ ràng và có thể kế thừa qua nhiều thế hệ bạn trẻ.

Năm 2026, Câu lạc bộ Thiện nguyện Hoa Trên Đá chính thức được thành lập, với anh Đoàn Xuân Lộc đảm nhận vai trò Trưởng ban điều hành trong giai đoạn khởi đầu.

Nhưng Hoa Trên Đá chưa bao giờ được tạo nên bởi một cá nhân đơn lẻ. Tổ chức này được vun đắp bởi tập thể những con người sẵn lòng chung tay: người có sức góp sức, người có thời gian góp thời gian, người có chuyên môn góp chuyên môn, và đôi khi chỉ cần một người sẵn lòng chia sẻ câu chuyện để một hoàn cảnh khó khăn được biết đến nhiều hơn.

![Đoàn tình nguyện trên đường thực địa vùng cao](/images/bai2_5.webp)

Chúng mình mong muốn xây dựng Hoa Trên Đá thành một môi trường nơi mỗi thành viên không chỉ làm những việc có ích cho xã hội, mà còn học cách sống trách nhiệm hơn, trưởng thành hơn qua từng trải nghiệm thực tế và cùng nhau tạo nên những chương trình có thể duy trì bền vững theo năm tháng.

Phía trước sẽ còn rất nhiều chặng đường mới, và chúng mình tin rằng sự chân thành sẽ luôn là cầu nối bền chặt nhất đưa những tấm lòng nhân ái đến gần nhau hơn.`,
    coverImage: '/images/bai2_1.webp',
    authorName: 'Ban Điều Hành',
    storyType: 'Nhật ký hành trình',
    featured: true,
    status: 'published',
  ...
  },
  {
    ...
    content: `Một câu lạc bộ thiện nguyện không được định nghĩa bằng những lời nói hoa mỹ, mà bằng những việc làm thực chất mang lại giá trị cụ thể cho cộng đồng. Đó cũng là kim chỉ nam mà Câu lạc bộ Thiện nguyện Hoa Trên Đá kiên định theo đuổi.

Chúng mình không đặt mục tiêu làm những điều quá to tát ngay từ những ngày đầu. Chúng mình chọn bắt đầu bằng những việc thiết thực, bền bỉ và sát sườn nhất với nhu cầu đời sống của người dân và các em nhỏ.

### 1. Đồng hành cùng trẻ em và đồng bào vùng cao

Hoa Trên Đá hướng về các điểm trường và thôn bản vùng sâu vùng xa, nơi điều kiện sinh hoạt và học tập của các em còn nhiều thiếu thốn. CLB tập trung vào các giải pháp bền vững: xây dựng và lắp đặt hệ thống đèn năng lượng mặt trời thắp sáng đường làng, nấu những bữa ăn dinh dưỡng ấm nóng cho học sinh và bà con dân bản, kết hợp trao tặng áo ấm, sách vở và đồ dùng học tập thiết yếu.

![Hoạt động hỗ trợ phát triển bền vững](/images/bai3_2.webp)

### 2. Nồi cháo yêu thương tại các bệnh viện

Hằng tuần và định kỳ hằng tháng, các thành viên tổ chức nấu và phát cháo dinh dưỡng miễn phí tại Trung tâm Y tế huyện Duy Xuyên và Quế Sơn. Mỗi suất cháo ấm nóng trao tận tay người bệnh nghèo và thân nhân không chỉ là sự tiếp sức về vật chất, mà còn là lời động viên tinh thần chân thành giữa những ngày tháng điều trị gian nan.

### 3. Hỗ trợ học sinh nghèo vượt khó hằng tháng

Nhằm giúp các em nhỏ không phải dang dở con đường tìm kiếm tri thức vì hoàn cảnh ngặt nghèo, CLB duy trì quỹ học bổng đồng hành thường xuyên, trao chi phí hỗ trợ học tập đều đặn hằng tháng và thăm hỏi, khích lệ tinh thần để các em yên tâm tới trường.

![Hoạt động thăm hỏi và động viên](/images/bai3_4.webp)

### 4. Cứu trợ khẩn cấp và các trường hợp tai nạn đột xuất

Bên cạnh các chương trình dài hạn, Hoa Trên Đá luôn chủ động xác minh và kịp thời phát động kêu gọi tiếp sức cho các ca tai nạn bất ngờ, bệnh nhân mắc bệnh hiểm nghèo cần kinh phí phẫu thuật gấp, hoặc các hộ gia đình chịu ảnh hưởng nặng nề bởi thiên tai bão lũ.

Mọi sự đóng góp của quý nhà hảo tâm đều được tiếp nhận và công khai minh bạch thời gian thực trên website của câu lạc bộ. Bởi với Hoa Trên Đá, sự tử tế cần niềm tin, và niềm tin phải luôn được xây dựng bằng sự minh bạch và tinh thần trách nhiệm cao nhất.`,
    coverImage: '/images/bai3_1.webp',
    authorName: 'Nguyễn Quang Hiếu',
    storyType: 'Tin tức hoạt động',
    featured: true,
    status: 'published',
    publishedAt: '2026-08-05T00:00:00Z',
    createdAt: '2026-08-05T00:00:00Z',
